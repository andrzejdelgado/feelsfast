/**
 * Source of the feelsfast skill.
 *
 * This is the markdown installed by users into their Claude Code, Cursor,
 * Copilot, Aider, or other agent tools. The /skill page renders it; users
 * can also download the raw file from /feelsfast.skill.md.
 *
 * Voice: Andrzej Delgado writing-style skill — analytical, em-dash heavy,
 * opinionated, no AI-slop filler.
 */
export const FEELSFAST_SKILL_SOURCE = `---
name: feelsfast
