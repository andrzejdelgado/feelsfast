...
export const references: readonly Reference[] = [
  ...
  },
  {
    ...
    label: "Weber–Fechner",
    citation:
      "Weber, E. H. & Fechner, G. T. (c. 1834+). The Weber–Fechner Law of perceived stimulus intensity. Foundational psychophysics; UX-readable application: Mishunov, Why Performance Matters: The Perception of Time (Smashing Magazine, 2015).",
  },
  {
    id: "eizenberg",
    label: "Eizenberg",
