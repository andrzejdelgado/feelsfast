...
The next essay covers the dark side: where these perception tricks cross into deception. Fake streaming, manipulated cadence, hidden tool calls, polished UX over uncertain output. AI is the surface where perception engineering and honesty come into the sharpest tension, and the rest of the canon does not yet have a clean vocabulary for it.
