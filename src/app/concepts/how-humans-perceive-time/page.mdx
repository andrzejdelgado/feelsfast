...
The practical consequence is severe and immediate. The first second of any wait is gold — keep the user active and the wait barely registers. Past one second, they enter passive mode and the time-stretching kicks in. This is exactly why patterns like pre-action feedback, optimistic UI, and predictive preloading carry their weight: they buy time inside the active window, where seconds count for less.
...
First, all of this is averaged behaviour. There are people who tolerate ten-second waits without flinching and people who churn at three. Your real users are a distribution, not the mean of a 1968 study. Treat the thresholds as design pressure, not as fixed constants.

Second, none of this absolves you from making the actual UI fast. Perception research tells you how to spend the budget you have. It does not tell you how big the budget should be. If your app's TTI is fifteen seconds, a tuned loading sequence does not save you — Eizenberg's argument from the previous essay still applies. Perception engineering wins the close races. It does not win the lopsided ones.
...
The next essay is the canonical thresholds — Miller, Card et al., Doherty, Nielsen — and exactly what they did and did not say. Most of what you have read about the 0.1 / 1 / 10-second rule is either a paraphrase or a folkloric edit. We go to the originals.
