...
export const metadata = {
  ...
  alternates: { canonical: "/scenarios/real-time-updates" }
};
...
<ScenarioMeta slug="real-time-updates" />
...
<DemoRunner config={realTimeUpdatesConfig} Naive={NaiveRealTimeUpdates} Tuned={TunedRealTimeUpdates} />
