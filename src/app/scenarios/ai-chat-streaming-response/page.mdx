...
import { config as threeDotBounceConfig } from "@/demos/technique-three-dot-bounce/config";
...
export const metadata = {
  ...
  alternates: { canonical: "/scenarios/ai-chat-streaming-response" }
};
...
<ScenarioMeta slug="ai-chat-streaming-response" />
...
<DemoRunner config={threeDotBounceConfig} Naive={NaiveThreeDotBounce} Tuned={TunedThreeDotBounce} />

<DemoRunner config={thinkingGradientConfig} Naive={NaiveThinkingGradient} Tuned={TunedThinkingGradient} />
