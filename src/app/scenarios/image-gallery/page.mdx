...
<DemoRunner config={imageGalleryConfig} Naive={NaiveImageGallery} Tuned={TunedImageGallery} />
...
<DemoRunner config={imageBrandConfig} Naive={NaiveImageBrand} Tuned={TunedImageBrand} />

<DemoRunner config={imageColorConfig} Naive={NaiveImageColor} Tuned={TunedImageColor} />
