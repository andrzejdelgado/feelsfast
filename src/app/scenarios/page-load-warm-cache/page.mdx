...
export const metadata = {
  ...
  alternates: { canonical: "/scenarios/page-load-warm-cache" }
};
...
<DemoRunner config={topBarConfig} Naive={NaiveTopBar} Tuned={TunedTopBar} />

<DemoRunner config={skeletonRevealConfig} Naive={NaiveSkeletonReveal} Tuned={TunedSkeletonReveal} />
