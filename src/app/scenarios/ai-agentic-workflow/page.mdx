...
export const metadata = {
  ...
  alternates: { canonical: "/scenarios/ai-agentic-workflow" }
};
...
<ScenarioMeta slug="ai-agentic-workflow" />
...
<DemoRunner config={aiAgenticWorkflowConfig} Naive={NaiveAiAgenticWorkflow} Tuned={TunedAiAgenticWorkflow} />
